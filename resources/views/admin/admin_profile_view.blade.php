...
@section('admin')
    {{--this is for to make workable choose box--}}
        ...
        <div class="row">
            <div class="col-lg-4 col-xl-4">
                <div class="card text-center">
                    <div class="card-body">
                        <img src="{{ (!empty($adminData->photo)) ? url('upload/admin_image/'.$adminData->photo) : url('upload/no_image.jpg') }}" class="rounded-circle avatar-lg img-thumbnail"More actions
                             alt="profile-image">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" name="email" id="email" value="{{$adminData->email}}">
                                            </div>
                                        </div> <!-- end col -->
                                    </div> <!-- end row -->
