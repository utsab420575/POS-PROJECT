...
<table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
            ...
            <h2 style="color: green; font-size: 26px;"><strong>UtsabShop</strong></h2>
        </td>
        <td align="right">
            <pre class="font">
               UtsabShop Head Office
               Email:utsab@duet.ac.bd <br>
               Mob: 11111111111 <br>
               Dhaka 1207,DUET:#4 <br>
...
<table width="100%">
    ...
    @foreach($orderItem as $item)
        <tr class="font">
            <td align="center">
                <img src="{{ public_path($item->product->product_image) }}" height="50px" width="50px" alt="Product Image">
            </td>
