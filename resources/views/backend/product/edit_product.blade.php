                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="product_garage" class="form-control" required value="{{ $product->product_garage }}">
                                                @error('product_garage') <span class="text-danger">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="product_store" class="form-control" required value="{{ $product->product_store }}">
                                                @error('product_store') <span class="text-danger">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="buying_date" class="form-control" required value="{{ $product->buying_date }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="expire_date" class="form-control" required value="{{ $product->expire_date }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="buying_price" class="form-control" required value="{{ $product->buying_price}}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <img id="showImage" src="{{ (!empty($product->product_image)) ? asset($product->product_image) : url('upload/no_image.jpg') }}" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
                                            </div>
                                        </div>
