                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a  class="btn btn-primary rounded-pill waves-effect waves-light" href="{{ route('product.all') }}">Back </a></li>
                            ...
                            <div class="tab-pane" id="settings">
                                ...
                                <div class="row">
                                    ...
                                    {{--<div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label for="firstname" class="form-label">Product BarCode    </label>
                                            <img src="{{ $barcodePath }}" alt="Barcode for {{ $product->product_code }}"
                                                 style="max-width: 100%; height: auto; border: 0px solid #ccc; padding: 8px;">
