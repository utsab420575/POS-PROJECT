                        ...
                        <div class="card-body">
                            <form action="{{route('employee.attendance.update')}}" method="POST" id="attendanceForm">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" name="date" class="form-control form-control-sm p-2"  value="{{$date}}"required>
                                </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach ($employees as $key => $employee)
                                        @php
                                            $status = isset($attendanceData[$employee->id]) ? $attendanceData[$employee->id]->status : null;
                                            $group = "status_group_$key";
                                        @endphp
                                        <tr>
                                            ...
                                            <td class="p-0 align-middle">
                                                <input type="radio" class="btn-check"
                                                       ...
                                                       value="present" autocomplete="off" {{ $status == 'present' ? 'checked' : '' }}
                                                       data-group="{{ $group }}" data-color="success">
                                                <label class="btn {{ $status == 'present' ? 'btn-success' : 'btn-outline-secondary' }} w-100 m-0 py-2 d-flex align-items-center justify-content-center"
                                            ...
                                            <td class="p-0 align-middle">
                                                <input type="radio" class="btn-check"
                                                       ...
                                                       value="leave" autocomplete="off" {{ $status == 'leave' ? 'checked' : '' }}
                                                       data-group="{{ $group }}" data-color="warning">
                                                <label class="btn {{ $status == 'leave' ? 'btn-warning' : 'btn-outline-secondary' }} w-100 m-0 py-2 d-flex align-items-center justify-content-center"
                                            ...
                                            <td class="p-0 align-middle">
                                                <input type="radio" class="btn-check"
                                                       ...
                                                       value="absent" autocomplete="off" {{ $status == 'absent' ? 'checked' : '' }}
                                                       data-group="{{ $group }}" data-color="danger">
                                                <label class="btn {{ $status == 'absent' ? 'btn-danger' : 'btn-outline-secondary' }} w-100 m-0 py-2 d-flex align-items-center justify-content-center"
